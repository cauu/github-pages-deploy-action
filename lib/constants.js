...
exports.targetRepositoryPath = exports.action.targetRepo ? `https://${exports.action.accessToken ||
    `x-access-token:${exports.action.gitHubToken}`}@github.com/${exports.action.targetRepo}.git` : '';
